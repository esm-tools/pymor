...
This module provides fixtures for locating test data and mesh files, either by:
- Downloading real data from remote storage
- Cloning mesh from git repository (with git-lfs)
- Generating lightweight stub data and mesh files
- Routing between them based on environment
"""
...
def fesom_uxarray_real_datadir():
    """
    ...
    return fetch_and_extract("fesom_uxarray.tar", registry_path=registry_path)
...
def fesom_uxarray_stub_datadir(tmp_path_factory):
    ...
    stub_dir = tmp_path_factory.mktemp("fesom_uxarray_stub")
...
@pytest.fixture(scope="session")
def fesom_uxarray_datadir(request):
    """
    ...
    if use_real:
        logger.info("Using real data for fesom_uxarray")
        return request.getfixturevalue("fesom_uxarray_real_datadir")
    else:
        logger.info("Using stub data for fesom_uxarray")
        return request.getfixturevalue("fesom_uxarray_stub_datadir")


@pytest.fixture(scope="session")
def fesom_uxarray_download_mesh(tmp_path_factory):
    """
...
@pytest.fixture(scope="session")
def fesom_uxarray_real_meshdir(fesom_uxarray_download_mesh):
    """Return the cloned git repository directory containing FESOM PI mesh files."""
    return fesom_uxarray_download_mesh


@pytest.fixture(scope="session")
def fesom_uxarray_stub_meshdir(tmp_path_factory):
    """
    Generate stub mesh for fesom_uxarray from YAML manifest.
    ...
    stub_dir = tmp_path_factory.mktemp("fesom_uxarray_stub_mesh")
...
@pytest.fixture(scope="session")
def fesom_uxarray_meshdir(request):
    """
    ...
    if use_real:
        logger.info("Using real mesh for fesom_uxarray")
        return request.getfixturevalue("fesom_uxarray_real_meshdir")
    else:
        logger.info("Using stub mesh for fesom_uxarray")
        return request.getfixturevalue("fesom_uxarray_stub_meshdir")


# Deprecated aliases for backward compatibility
@pytest.fixture(scope="session")
def pi_uxarray_real_data(fesom_uxarray_real_datadir):
    """Deprecated: Use fesom_uxarray_real_datadir instead."""
    import warnings

    warnings.warn(
        "pi_uxarray_real_data is deprecated, use fesom_uxarray_real_datadir",
        DeprecationWarning,
        stacklevel=2,
    )
...
def pi_uxarray_stub_data(fesom_uxarray_stub_datadir):
    """Deprecated: Use fesom_uxarray_stub_datadir instead."""
    import warnings

    warnings.warn(
        "pi_uxarray_stub_data is deprecated, use fesom_uxarray_stub_datadir",
        DeprecationWarning,
        stacklevel=2,
    )
...
def pi_uxarray_real_mesh(fesom_uxarray_real_meshdir):
    """Deprecated: Use fesom_uxarray_real_meshdir instead."""
    import warnings

    warnings.warn(
        "pi_uxarray_real_mesh is deprecated, use fesom_uxarray_real_meshdir",
        DeprecationWarning,
        stacklevel=2,
    )
...
def pi_uxarray_stub_mesh(fesom_uxarray_stub_meshdir):
    """Deprecated: Use fesom_uxarray_stub_meshdir instead."""
    import warnings

    warnings.warn(
        "pi_uxarray_stub_mesh is deprecated, use fesom_uxarray_stub_meshdir",
        DeprecationWarning,
        stacklevel=2,
    )
