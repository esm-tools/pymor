...
Mittel. Sie tragen aktuell noch \code{g130}, \code{g129} oder \code{g122} und
behaupten damit ein Gitter, auf dem sie nicht liegen.

Wir haben im Register \code{g190} gefunden, "A single grid cell for the entire globe",
und uns bewusst dagegen entschieden. Es ist ein echter Zelleneintrag mit Geometrie
(\code{n\_cells: 1}, \code{southernmost\_latitude: -90}, \code{x\_resolution: 360},
\code{y\_resolution: 180}), wir wuerden also eine Ausdehnung behaupten, die unsere
Dateien gar nicht mitliefern; sie enthalten weder \code{lat} noch \code{lon} noch
Bounds. Ausserdem verweist im ganzen Register niemand darauf, und von 139~Eintraegen
ist es der einzige mit einer Zelle. Es sieht also nicht nach einer etablierten
Konvention aus, der wir uns anschliessen koennten.

Wenn der reservierte Bereich der ersten 100 Label dafuer vorgesehen ist, warten wir
darauf.
