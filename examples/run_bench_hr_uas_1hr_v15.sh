#!/bin/bash
#SBATCH --job-name=pycmor-bench-uas_1hr_v15-v14
...
#SBATCH --output=pycmor_bench_hr_uas_1hr_v15_%j.log
#SBATCH --error=pycmor_bench_hr_uas_1hr_v15_%j.log
...
OUTROOT=${OUTROOT:-/scratch/a/a270092/pycmor_bench_uas_1hr_v15}
...
python3 - <<PY
import yaml
y = yaml.safe_load(open("examples/cmip7_bench_hr_uas_1hr_v15.yaml"))
