#!/bin/bash
#SBATCH --job-name=pycmor-bench-uas_1hr_v14style-v14
...
#SBATCH --output=pycmor_bench_hr_uas_1hr_v14style_%j.log
#SBATCH --error=pycmor_bench_hr_uas_1hr_v14style_%j.log
...
OUTROOT=${OUTROOT:-/scratch/a/a270092/pycmor_bench_uas_1hr_v14style}
...
python3 - <<PY
import yaml
y = yaml.safe_load(open("examples/cmip7_bench_hr_uas_1hr_v14style.yaml"))
