#!/bin/bash
#SBATCH --job-name=pycmor-bench-zg_6hr_baseline
...
#SBATCH --output=pycmor_bench_hr_zg_6hr_baseline_%j.log
#SBATCH --error=pycmor_bench_hr_zg_6hr_baseline_%j.log
...
OUTROOT=${OUTROOT:-/scratch/a/a270092/pycmor_bench_zg_6hr_baseline}
...
python3 - <<PY
import yaml
y = yaml.safe_load(open("examples/cmip7_bench_hr_zg_6hr_baseline.yaml"))
