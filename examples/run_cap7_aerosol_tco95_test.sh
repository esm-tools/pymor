#!/bin/bash
#SBATCH --job-name=pycmor-cap7-aerosol-tco95-test
...
#SBATCH --output=pycmor_cap7_aerosol_tco95_test_%j.log
#SBATCH --error=pycmor_cap7_aerosol_tco95_test_%j.log
...
sed -e 's/dask_cluster: "slurm"/dask_cluster: "local"/' \
    ...
    examples/cmip7_cap7_aerosol_tco95_test.yaml > $PYCMOR_SCRATCH/cap7_aerosol_tco95_test_local.yaml

pycmor process $PYCMOR_SCRATCH/cap7_aerosol_tco95_test_local.yaml
