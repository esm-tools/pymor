#!/bin/bash
#SBATCH --job-name=pycmor-core-atm-tco95-test
...
#SBATCH --output=pycmor_core_atm_tco95_test_%j.log
#SBATCH --error=pycmor_core_atm_tco95_test_%j.log
...
sed -e 's/dask_cluster: "slurm"/dask_cluster: "local"/' \
    ...
    examples/cmip7_core_atm_tco95_test.yaml > $PYCMOR_SCRATCH/core_atm_tco95_test_local.yaml

pycmor process $PYCMOR_SCRATCH/core_atm_tco95_test_local.yaml
