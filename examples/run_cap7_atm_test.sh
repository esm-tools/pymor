#!/bin/bash
#SBATCH --job-name=pycmor-cap7-atm-test
...
#SBATCH --output=pycmor_cap7_atm_test_%j.log
#SBATCH --error=pycmor_cap7_atm_test_%j.log
...
pycmor process $PYCMOR_SCRATCH/cap7_atm_test_local.yaml
