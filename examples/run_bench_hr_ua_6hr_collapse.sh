#!/bin/bash
#SBATCH --job-name=pycmor-bench-ua-6hr-collapse
...
#SBATCH --output=pycmor_bench_hr_ua_6hr_collapse_%j.log
#SBATCH --error=pycmor_bench_hr_ua_6hr_collapse_%j.log
...
OUTROOT=${OUTROOT:-/scratch/a/a270092/pycmor_bench_ua_6hr_collapse}
...
python3 - <<PY
import yaml
y = yaml.safe_load(open("examples/cmip7_bench_hr_ua_6hr_collapse.yaml"))
