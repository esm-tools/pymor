#!/bin/bash
#SBATCH --job-name=pycmor-bench-ua-6hr-v12
...
#SBATCH --output=pycmor_bench_hr_ua_6hr_v12_%j.log
#SBATCH --error=pycmor_bench_hr_ua_6hr_v12_%j.log
...
OUTROOT=${OUTROOT:-/scratch/a/a270092/pycmor_bench_ua_6hr_v12}
