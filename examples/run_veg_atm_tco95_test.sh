#!/bin/bash
#SBATCH --job-name=pycmor-veg-atm-tco95-test
...
#SBATCH --output=pycmor_veg_atm_tco95_test_%j.log
#SBATCH --error=pycmor_veg_atm_tco95_test_%j.log
...
sed -e 's/dask_cluster: "slurm"/dask_cluster: "local"/' \
    ...
    examples/cmip7_veg_atm_tco95_test.yaml > $PYCMOR_SCRATCH/veg_atm_tco95_test_local.yaml

pycmor process $PYCMOR_SCRATCH/veg_atm_tco95_test_local.yaml
