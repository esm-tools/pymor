...
\ok\ Hier war unsere Antwort beim letzten Mal missverst\"andlich: das ist kein
Schritt, den wir vor der Publikation nachholen. \code{cmip7repack} l\"auft bei uns
als fester Teil des Schreib-Workflows auf jeder Datei, in \code{cli111} 542-mal.

Die beiden konkreten Punkte sind damit weg:

\begin{center}
\begin{tabular}{lrr}
\toprule
& \textbf{gemeldet} & \textbf{\code{cli111}} \\
\midrule
...
Gegengepr\"uft mit \code{cmip7repack -x} auf genau der Datei, die du zitiert
hattest: \code{"not rechunking"} f\"ur \code{time}, \code{time\_bnds} und
\code{rsus}, es bleibt also nichts zu tun.
