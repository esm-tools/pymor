...
Die gr\"o\ss te Gruppe, \code{ATTR004} \code{long\_name}, ist gemischt. Ein Teil
geh\"ort uns: \code{hfdsl} tr\"agt \code{"Ground heat flux at 3hr"} statt
\code{"Downward Heat Flux at Land Surface"}. Ein Teil ist Wortlaut
(\code{"sea water"} gegen \code{"seawater"}). Und ein Teil sieht nach einem
Registry-Fehler aus: f\"ur \code{land.cVeg.tavg-u-hxy-shb.mon.glb}, also die
Strauch-Kachel, erwartet die Registry \code{"Carbon Mass in Vegetation on Grass
Tiles"}. Wir gehen die Liste durch und melden, was upstream geh\"ort, statt die
Registry-Werte blind zu \"ubernehmen.
