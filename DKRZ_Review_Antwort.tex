...
\ok\ \code{cmip7repack} l\"auft bei uns als fester Teil des Schreib-Workflows auf
jeder Datei, nicht erst vor der Publikation, in \code{cli111} 542-mal.
...
\code{time\_bnds} und \code{rsus}, es bleibt also nichts zu rechunken. Und
\code{h5stat -S} zeigt \code{File metadata: 165725 bytes}, genau die
\code{metadata\_block\_size}, die \code{cmip7repack} f\"ur diese Datei berechnet
und gesetzt hat, die Metadaten liegen also in einem Block.
